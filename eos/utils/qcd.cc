...
namespace eos
{
    ...
    // cf. [CKS:2000A], Eq. (2), p. 2 with n_f = 6
    ...
    // cf. [CKS:2000A], Eq. (2), p. 2 with n_f = 5
    ...
    // cf. [CKS:2000A], Eq. (7), p. 5 with n_f = 5
    ...
    // cf. [CKS:2000A], Eq. (2), p. 2 with n_f = 4
    ...
    // cf. [CKS:2000A], Eq. (7), p. 5 with n_f = 4
    ...
    // cf. [CKS:2000A], Eq. (2), p. 2 with n_f = 3
    ...
    // cf. [CKS:2000A], Eq. (7), p. 5 with n_f = 3
    ...
    QCD::m_q_msbar(const double & m_q_pole, const double & alpha_s, const double & nf)
    {
        ...
        // cf. [MvR:1999A], Eq. (12), pp. 4-5 for alpha_s = alpha_s(m_q_pole)
