...
#include <eos/form-factors/parametric-kkrvd2024b.hh>
...
namespace eos
{
    KKRvD2024BFormFactors<PiToPi>::KKRvD2024BFormFactors(const Parameters & p, const Options & /*o*/) :
        _b_fp_I1{{
        ...
        _re_c_fp_I1(p["pi->pi::Re{c}_(+,1)@KKRvD2024B"], *this),
        _im_c_fp_I1(p["pi->pi::Im{c}_(+,1)@KKRvD2024B"], *this),
        _M_fp_I1(p["pi->pi::M_(+,1)@KKRvD2024B"], *this),
        _G_fp_I1(p["pi->pi::Gamma_(+,1)@KKRvD2024B"], *this),
        _m_pi(p["mass::pi^+"], *this),
        _t_0(p["pi->pi::t_0@KKRvD2024B"], *this)
    {
    }

    KKRvD2024BFormFactors<PiToPi>::~KKRvD2024BFormFactors() = default;

    FormFactors<PToP> *
    KKRvD2024BFormFactors<PiToPi>::make(const Parameters & p, const Options & o)
    {
        return new KKRvD2024BFormFactors<PiToPi>(p, o);
    }

    double
    KKRvD2024BFormFactors<PiToPi>::z(const double & q2) const
    {
        return _z(q2, this->_t_0());
    }

    double
    KKRvD2024BFormFactors<PiToPi>::phi_p(const double & z, const double & chi) const
    {
    ...
    double
    KKRvD2024BFormFactors<PiToPi>::series_m(const double & z, const std::array<double, 10u> & c) const
    {
    ...
    double
    KKRvD2024BFormFactors<PiToPi>::_b0_fp_I1(const double & chi, const complex<double> & zr, const complex<double> & cr) const
    {
    ...
    double
    KKRvD2024BFormFactors<PiToPi>::f_p(const double & q2) const
    {
    ...
    double
    KKRvD2024BFormFactors<PiToPi>::f_plus_T(const double & /*q2*/) const
    {
    ...
    double
    KKRvD2024BFormFactors<PiToPi>::f_t(const double & /*q2*/) const
    {
        throw InternalError("Not implemented!");
        return 1.0;
    }
    ...
    double
    KKRvD2024BFormFactors<PiToPi>::f_0(const double & /*q2*/) const
    {
        return 0.0; // vanishes in our approximation
    }

    template class KKRvD2024BFormFactors<PiToPi>;

    /* Vacuum -> pi pi */
    KKRvD2024BFormFactors<VacuumToPiPi>::KKRvD2024BFormFactors(const Parameters & p, const Options & /*o*/) :
        _b_fp_I1{{
            UsedParameter(p[_par_name("+", "1", "1")], *this),
            UsedParameter(p[_par_name("+", "1", "2")], *this),
            UsedParameter(p[_par_name("+", "1", "3")], *this),
    ...
    KKRvD2024BFormFactors<VacuumToPiPi>::~KKRvD2024BFormFactors() = default;

    FormFactors<VacuumToPP> *
    KKRvD2024BFormFactors<VacuumToPiPi>::make(const Parameters & p, const Options & o)
    {
        return new KKRvD2024BFormFactors<VacuumToPiPi>(p, o);
    }
    ...
    complex<double>
    KKRvD2024BFormFactors<VacuumToPiPi>::phi_p(const complex<double> & z, const double & chi) const
    {
        const double t_p     = this->_t_p();
        const double t_0     = this->_t_0();
        const double tfactor = 1.0 - t_0 / t_p;
    ...
    complex<double>
    KKRvD2024BFormFactors<VacuumToPiPi>::series_m(const complex<double> & z, const std::array<double, 10u> & c) const
    {
    ...
    double
    KKRvD2024BFormFactors<VacuumToPiPi>::_b0_fp_I1(const double & chi, const complex<double> & zr, const complex<double> & cr) const
    {
        const auto z0 = this->z(0.0);
        const auto phi_z0 = this->phi_p(z0, chi);
    ...
    complex<double>
    KKRvD2024BFormFactors<VacuumToPiPi>::f_p(const complex<double> & q2) const
    {
        const auto z           = this->z(q2);
        const auto chi         = 0.0258815; // GeV^-2, from Meril at Q^2 = 1 GeV^2
        const auto phi         = this->phi_p(z, chi);
    ...
    complex<double>
    KKRvD2024BFormFactors<VacuumToPiPi>::f_t(const double & /*q2*/) const
    {
        throw InternalError("Not implemented!");
        return 0.0;
    }
    ...
    complex<double>
    KKRvD2024BFormFactors<VacuumToPiPi>::f_0(const double & /*q2*/) const
    {
        return 0.0; // vanishes in our approximation
    }

    template class KKRvD2024BFormFactors<VacuumToPiPi>;
}
