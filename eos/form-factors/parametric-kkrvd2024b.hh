...
#ifndef EOS_GUARD_EOS_FORM_FACTORS_PARAMETRIC_KKRvD2024BB_HH
#define EOS_GUARD_EOS_FORM_FACTORS_PARAMETRIC_KKRvD2024BB_HH 1
...
namespace eos
{
    template <typename Process_> class KKRvD2024BFormFactors;
        ...
        public FormFactors<PToP>
    {
        private:
            ...
            {
                return "pi->pi::b_(" + ff + "," + isospin + ")^" + index + "@KKRvD2024B";
            }
        ...
        public:
            KKRvD2024BFormFactors(const Parameters & p, const Options & o);
            ~KKRvD2024BFormFactors();
    ...
    extern template class KKRvD2024BFormFactors<PiToPi>;
